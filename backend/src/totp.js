/* =====================================================================
   VERIFICAÇÃO EM DUAS ETAPAS POR APP (TOTP — RFC 6238)
   ---------------------------------------------------------------------
   ...
   janela de 30 segundos. Validada contra o vetor de teste oficial do
   RFC 6238 (Apêndice B).

   Usado só depois que a conta já ativou a verificação em duas etapas
   por e-mail (obrigatório) e quer trocar pro app autenticador nas
   configurações — ver customers.js.
   ===================================================================== */
...
module.exports = { generateSecret, generateOtpauthUri, verifyToken };
